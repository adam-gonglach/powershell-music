...
# Arrangement URL: https://www.ninsheetmusic.org/download/pdf/2112
# ============================================================
...
Add-Melody-Chord $C4_A4 $TripletEighth
Add-Melody-Chord $Db4_Bb4 $TripletEighth
Add-Melody-Chord $D4_B4 $TripletEighth

Add-Melody-Chord $Eb4_C5 ($Quarter + $Eighth)
...
Add-Harmony-Chord $C3_F3 $TripletEighth
Add-Harmony-Chord $Db3_Gb3 $TripletEighth
Add-Harmony-Chord $D3_B3 $TripletEighth

Add-Harmony-Chord $Eb3_Ab3 ($Quarter + $Eighth)
